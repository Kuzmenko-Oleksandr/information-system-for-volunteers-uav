        ...
        <section class="content mt-5">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <form action="{{ route('volunteer.post.update', $post->id) }}" method="POST" class="col-4"
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="exampleInputFile"
                                           name="preview_image">
                                    <label for="exampleInputFile" class="custom-file-label">Оберіть зображення для
                                        превью</label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="exampleInputFile"
                                           name="main_image">
                                    <label for="exampleInputFile" class="custom-file-label">Оберіть головне
                                        зображення</label>
                                </div>
                                <div class="input-group-append">
                                    <span class="input-group-text">Додати фото</span>
                        ...
                        <div class="form-group">
                            ...
                            <select data-placeholder="Select tags" name="tag_ids[]" multiple="multiple" id=""
                                    class="select2 w-100">
                                @foreach($tags as $tag)
                                    <option
                        ...
                        <div class="form-group">
                            ...
                            <select name="visibility" class="form-control">
                                <option value="all" {{ $post->visibility == 'all' ? 'selected' : '' }}>Відображати
                                    всім
                                </option>
                                <option value="registered" {{ $post->visibility == 'registered' ? 'selected' : '' }}>
                                    Відображати тільки зареєстрованим користувачам
                                </option>
                                <option
                                    value="admin_volunteer" {{ $post->visibility == 'admin_volunteer' ? 'selected' : '' }}>
                                    Відображати адміністратору та волонтерам
                                </option>
                            </select>
                            @error('visibility')
